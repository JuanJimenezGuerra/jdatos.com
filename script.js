...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Clases para los elementos animados (puntos, líneas)
    class Point {
        constructor() {
        ...
        update() {
            ...
            if (this.x < 0 || this.x > width || this.y < 0 || this.y > height) {
                return true; // Reiniciar el elemento
            }
            return false;
        }
    }
    ...
    // --- Lógica de Transición de Pestañas (ya existente) ---
    tabLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // Actualiza el título y la imagen de transición
